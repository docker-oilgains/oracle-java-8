...
Locally, we build the images above like this:

```
 docker build --file ubuntu18.dockerfile -t oracle-java-8:ubuntu18 .
 docker run --rm -v $PWD:/app -w /app oracle-java-8:ubuntu18 javac Main.java
 docker run --rm -v $PWD:/app -w /app oracle-java-8:ubuntu18 java Main
```



```
docker build --file debian10.Dockerfile -t oracle-java-8:debian10 .
docker run --rm -v $PWD:/app -w /app oracle-java-8:debian10 javac Main.java
docker run --rm -v $PWD:/app -w /app oracle-java-8:debian10 java Main
```
